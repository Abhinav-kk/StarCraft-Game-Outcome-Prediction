...
estimator11 = tf.keras.models.load_model(os.getcwd() + '/models/simple_NN_model')
estimator12 = tf.keras.models.load_model(os.getcwd() + '/models/gameState_NN_model')
estimator13 = load(os.getcwd() + '/models/csv_random_forest_model.joblib')
simpleScaler = load(os.getcwd() + '/models/Scalers/SimpleStandardScaler.joblib')
gameStatescaler = load(os.getcwd() + '/models/Scalers/GameStateStandardScaler.joblib')
